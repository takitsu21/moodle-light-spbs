...
Contexte:
  Etant donné Un enseignant avec le nom de connexion "Jacques"
    ...
    Et un module "Français" qui a un cours "Test" et qui a un enseignant "Jacques"
  ...
  Scénario: Suppresion d'une ressource cours d'un module
    Quand "Jacques" veut supprimer le cours "Test" du module "Français"
    Alors le dernier status de réponse est 200 crs
  ...
  Scénario: Suppresion d'une ressource cours d'un module qui ne contient pas ce cours
    Quand "Jacques" veut supprimer le cours "Test2" du module "Français"
    Alors le dernier status de réponse est 400 crs
