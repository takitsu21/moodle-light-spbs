...
Fonctionnalité: Professeur modifie (nom/description) ou supprime une question
  ...
  Contexte:
    ...
    Et une question QCM d'identifiant 1 et de nom "Ordinateur" et de description "Bonjour ?" et le numéro 1 appartenant au questionnaire "Test35" tmdqd

  Scénario: Supprimer une question appartenant a un module que l'on possède
    Quand Le professeur "Jean" veut supprimer la question "Ordinateur" du questionnaire "Test35" du module "Gestion de projet" tmdqe
    Alors  le status de la dernière requète est 200 tmdqf
    Et la question "Ordinateur" n'existe plus tmdqg

  Scénario: Supprimer une question appartenant a un module que l'on ne possède pas
    Quand Le professeur "Marie" veut supprimer la question "Q1" du questionnaire "Test35" du module "Gestion de projet" tmdqh
    Alors le dernier status de réponse est 400 tmdqi
    Et la question "Ordinateur" existe tmdqj

  Scénario: Modifier le nom d'une question appartenant a un module que l'on possède
    Quand Le professeur "Jean" veut modifier le nom de la question d'identifiant 1 du questionnaire "Test35" du module "Gestion de projet" par "Ordinateur new" tmdqk
    Alors  le status de la dernière requète est 200 tmdqql
    Et la question d'identifant 1 a pour nom "Ordinateur new" tmdqm

  Scénario: Modifier le nom d'une question appartenant a une module qu'on ne possède pas
    Quand Le professeur "Marie" veut modifier le nom de la question d'identifant 1 du questionnaire "Test35" du module "Gestion de projet" par "Ordinateur mauvaise" tmdqn
    Alors le dernier status de réponse est 400 tmdqqo
    Et la question didentifant 1 s'appelle toujours "Ordinateur new" tmdqp

  Scénario: Modifier la description d'une question appartenant a un module que l'on possède
    Quand Le professeur "Jean" veut modifier la description de la question d'identifiant 1 du questionnaire "Test35" du module "Gestion de projet" par "Au revoir ?" tmdqq
  ...
  Scénario: Modifier la description d'une question appartenant a une module qu'on ne possède pas
    Quand Le professeur "Marie" veut modifier la description de la question d'identifiant 1 du questionnaire "Test35" du module "Gestion de projet" par "A midi ?" tmdqt
  ...
  Scénario: Modifier le numéro d'une question appartenant a un module que l'on possède
    Quand le professeur "Jean" veut modifier le numéro de la question d'identifiant 1 du questionnaire "Test35" du module "Gestion de projet" par 2 tmdqw
  ...
  Scénario: Modifier le numéro d'une question appartenant a un module que l'on ne possède pas
    Quand le professeur "Marie" veut modifier le numéro de la question d'indentifiant 1 du questionnaire "Test35" du module "Gestion de projet" par 3 tmdqz
