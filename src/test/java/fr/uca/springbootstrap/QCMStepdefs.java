...
public class QCMStepdefs {
    ...
    @Et("le QCM {string} du questionnaire {string} du module {string} a les reponses possible {string} et {string}")
    public void leQCMDuQuestionnaireDuModuleALesReponsesPossibleEt(String arg0, String arg1, String arg2, String arg3, String arg4) {
